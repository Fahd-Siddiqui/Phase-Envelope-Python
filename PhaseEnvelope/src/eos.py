...
class EOS:
    ...
    @classmethod
    def fugacity(cls, T: float, P: float, a: np.ndarray, b: np.ndarray, amix: float, bmix: float, Volume: float, MoleFrac: np.ndarray, kij: np.ndarray, lij: np.ndarray, index: int):
